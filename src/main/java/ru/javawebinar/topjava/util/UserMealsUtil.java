...
public class UserMealsUtil {
    ...
    public static Map<LocalDate, Integer> groupCaloriesByDate(Collection<UserMeal> mealList){
        return mealList.stream().collect(Collectors.groupingBy(um -> um.getDateTime().toLocalDate(), Collectors.summingInt(UserMeal::getCalories)));
    }

    public static List<UserMealWithExceed> convertWithExceeded(Collection<UserMeal> mealList, int caloriesPerDay) {
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded(Collection<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        Map<LocalDate, Integer> caloriesSumByDate = groupCaloriesByDate(mealList);
